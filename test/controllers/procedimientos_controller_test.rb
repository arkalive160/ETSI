...
class ProcedimientosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create procedimiento" do
    assert_difference('Procedimiento.count') do
      post procedimientos_url, params: { procedimiento: { descripcion: @procedimiento.descripcion, imagen: @procedimiento.imagen, titulo: @procedimiento.titulo } }
    end
  ...
  test "should update procedimiento" do
    patch procedimiento_url(@procedimiento), params: { procedimiento: { descripcion: @procedimiento.descripcion, imagen: @procedimiento.imagen, titulo: @procedimiento.titulo } }
