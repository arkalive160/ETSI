...
class UnidadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create unidad" do
    assert_difference('Unidad.count') do
      post unidads_url, params: { unidad: { competencias: @unidad.competencias, horas_unidad: @unidad.horas_unidad, nombre_unidad: @unidad.nombre_unidad } }
    end
  ...
  test "should update unidad" do
    patch unidad_url(@unidad), params: { unidad: { competencias: @unidad.competencias, horas_unidad: @unidad.horas_unidad, nombre_unidad: @unidad.nombre_unidad } }
