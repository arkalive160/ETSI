...
class ModulosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create modulo" do
    assert_difference('Modulo.count') do
      post modulos_url, params: { modulo: { descripcion: @modulo.descripcion, horas_modulo: @modulo.horas_modulo, nombre: @modulo.nombre } }
    end
  ...
  test "should update modulo" do
    patch modulo_url(@modulo), params: { modulo: { descripcion: @modulo.descripcion, horas_modulo: @modulo.horas_modulo, nombre: @modulo.nombre } }
