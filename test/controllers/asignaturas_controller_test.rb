...
class AsignaturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create asignatura" do
    assert_difference('Asignatura.count') do
      post asignaturas_url, params: { asignatura: { contenido: @asignatura.contenido, horas_asignatura: @asignatura.horas_asignatura, nombre_asignatura: @asignatura.nombre_asignatura } }
    end
  ...
  test "should update asignatura" do
    patch asignatura_url(@asignatura), params: { asignatura: { contenido: @asignatura.contenido, horas_asignatura: @asignatura.horas_asignatura, nombre_asignatura: @asignatura.nombre_asignatura } }
