...
class ActivosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create activo" do
    assert_difference('Activo.count') do
      post activos_url, params: { activo: { codigo: @activo.codigo, fecha_ingreso: @activo.fecha_ingreso } }
    end
  ...
  test "should update activo" do
    patch activo_url(@activo), params: { activo: { codigo: @activo.codigo, fecha_ingreso: @activo.fecha_ingreso } }
